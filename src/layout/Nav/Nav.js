...
function Nav() {
  ...
  return (
    <header>
    <Disclosure as="nav" className="bg-gray-900 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06]">
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  ...
                  key={"logo"}
                  to={"/"}
                  className={classNames("flex flex-shrink-0 items-center")}
                  >
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          ...
                          isLinkActive(item.href) ? 'bg-gray-700 text-white' : '',
